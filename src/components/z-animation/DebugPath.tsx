...
export default ({ path, index, stroke, strokeWidth }: DebugPathProps): React.ReactElement => {
  ...
  return (
    <>
      ...
      <AnimatedCircle animatedProps={circle1} r={strokeWidth / 2} fill={stroke} />
      <AnimatedCircle animatedProps={circle2} r={strokeWidth / 2} fill={stroke} />
    </>
  );
};
