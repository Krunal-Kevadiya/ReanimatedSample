...
const ZRect = ({ width, height, stroke, strokeWidth, debug, fill, transform }: ZRectProps): React.ReactElement => {
  ...
  return (
    <ZPath path={path} stroke={stroke} strokeWidth={strokeWidth} fill={fill} debug={debug} transform={transform} />
  );
};
