...
export const quadraticPoint = (xs: number[], ys: number[], t: number): Vector => {
  'worklet';
...
export const cubicDerivative = (xs: number[], ys: number[], t: number): Vector => {
  'worklet';
...
export const getQuadraticArcLength = (xs: number[], ys: number[], t: number): number => {
  'worklet';
  if (t === undefined) {
    t = 1;
  }
...
export const quadraticDerivative = (xs: number[], ys: number[], t: number): object => {
  'worklet';
  return {
...
export const getCubicArcLength = (xs: number[], ys: number[], t: number): number => {
  'worklet';
  let sum: number;
...
export const t2length = (length: number, totalLength: number, func: (t: number) => number): number => {
  'worklet';
  let error = 1;
